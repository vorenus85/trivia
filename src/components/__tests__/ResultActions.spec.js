...
describe('ResultActions', () => {
  ...
  it('render correctly', () => {
    wrapper = mount(ResultActions, { props: { showPlayAgain: true, showViewAnswers: true } })
  ...
  it('nor renter button if props are false', () => {
    wrapper = mount(ResultActions, { props: { showPlayAgain: false, showViewAnswers: false } })
  ...
  it('emits navToStart event with when clicked', async () => {
    wrapper = mount(ResultActions, { props: { showPlayAgain: true, showViewAnswers: false } })
  ...
  it('emits navToDetailedResults event with when clicked', async () => {
    wrapper = mount(ResultActions, { props: { showPlayAgain: false, showViewAnswers: true } })
